...
python inference.py --combine True --mask mask_e3 --gender gender_e3 --age age_e3
...
python inference.py --combine True --mask mask_e1 --gender gender_e1 --age age_e1
...
python inference.py --combine True --mask mask_c --gender gender_c --age age_c
